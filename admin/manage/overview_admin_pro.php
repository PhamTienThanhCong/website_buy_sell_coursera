                ...
                <div class="recent-sales box">
                    ...
                    <p>
                        ...
                        if ($_SESSION["lever"] == 2) {
                            ...
                            $result = mysqli_query($connection, "select count(*) as count from update_course group by id_course");
                            print("<li>Số Khóa học đang chờ update: " . mysqli_fetch_array($result)["count"]."</li>");
